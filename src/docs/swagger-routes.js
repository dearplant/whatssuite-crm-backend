 ...
 * tags:
 *   - name: E-commerce
 *     description: E-commerce integrations and abandoned cart recovery
 */
...
/**
 * @swagger
 * /api/v1/ecommerce/abandoned-carts/statistics:
 *   get:
...
/**
 * @swagger
 * /api/v1/ecommerce/abandoned-carts/{id}:
 *   get:
 ...
 *                     cart_url:
 *                       type: string
 *                       example: https://store.com/cart/abc123
 *                     total_amount:
 *                       type: number
 *                       example: 99.99
 *                     currency:
...
/**
 * @swagger
 * /api/v1/ecommerce/abandoned-carts/{id}/recover:
 *   post:
 *     summary: Manually trigger recovery for an abandoned cart
 *     tags: [E-commerce]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *                 message:
 *                   type: string
 *                   example: Recovery message sent successfully
 *                 data:
 *                   type: object
 *                   properties:
 *                     success:
 ...
 *                       type: string
 *       400:
 *         description: Recovery skipped (cart status changed, expired, etc.)
 *       404:
 *         description: Cart not found
 *       401:
 *         description: Unauthorized
